...
import { AddReview } from '../../page/add-review/add-review.tsx';
...
import { fetchFavoriteFilms, fetchMovies, getAuthorizationStatus } from '../../store/api-actions/api-actions.ts';
